...
export default function Register() {
    return (
        <div
            ...
            style={{ backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)), url('images/image-back-daftar.jpg')` }}
        >
            {/* Container kartu pendaftaran menggunakan Tailwind murni */}
            <div className="w-full max-w-[360px] md:max-w-[440px] bg-[#181a1c]/84 p-8 md:p-10 rounded-2xl text-center text-white backdrop-blur-sm shadow-2xl">
                ...
                {/* Judul & Subtitle */}
                <h2 className="text-[22px] md:text-[24px] font-bold mb-1.5 text-white">Daftar</h2>
                <p className="text-[12px] md:text-sm text-white/80 mb-7">Selamat datang!</p>

                {/* Form Register Organism */}
                <RegisterForm />
